...
class ShareLeaguePage extends StatefulWidget {
  final String title;
  final String code;
  final String playfor;
  final String participant;
  final String id;
  const ShareLeaguePage({Key? key,required this.code,required this.playfor,required this.participant,required this.title,required this.id}) : super(key: key);

  @override
  State<ShareLeaguePage> createState() => _ShareCupPageState();
}

class _ShareCupPageState extends State<ShareLeaguePage> {
  @override
    ...
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Share League",style: toolbarTitleStyle,),
           centerTitle: true,
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 20,),
                Center(child: SvgPicture.asset("assets/images/league_icon.svg",height: 107,width: 107,fit: BoxFit.fill,color: primaryColor,)),
                SizedBox(height: 40,),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 17,),
                          Text("${widget.playfor}",style: TextStyle(color: primaryColor,fontSize: 17,fontWeight: FontWeight.w600)),
                          SizedBox(width: 17,),
                          Expanded(
                            child: Divider(
                              thickness: 4,
                      ...
                      SizedBox(height: 20,),
                      Text("Private League: ${widget.participant} Participants",style: GoogleFonts.poppins(textStyle: TextStyle(color: commonTextColor,fontSize: 17,fontWeight: FontWeight.w600)),)
