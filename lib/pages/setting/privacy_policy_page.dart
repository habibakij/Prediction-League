...
class PrivacyPolicyPage extends StatefulWidget {
  final String id;
  const PrivacyPolicyPage({Key? key,required this.id}) : super(key: key);
  @override
  State<PrivacyPolicyPage> createState() => _EditProfilePageState();
}

class _EditProfilePageState extends State<PrivacyPolicyPage> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Obx(() => Text(langController.privacy_policy.value.toString(), style: TextStyle(color: Color(0xFF1A1819),fontSize: 12,fontWeight: FontWeight.w600)),),
