...
class TermsAndServicePage extends StatefulWidget {
  final String id;
  const TermsAndServicePage({Key? key,required this.id}) : super(key: key);
  @override
  State<TermsAndServicePage> createState() => _EditProfilePageState();
}

class _EditProfilePageState extends State<TermsAndServicePage> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Obx(() => Text(langController.terms_and_conditions.value.toString(), style: TextStyle(color: Color(0xFF1A1819),fontSize: 12,fontWeight: FontWeight.w600)),),
